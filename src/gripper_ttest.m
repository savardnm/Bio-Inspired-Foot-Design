...
louse_normal_trimmed =  [193.10,220.70,704.65,531.20,263.10,381.35,259.40,268.30,652.10,239.50,408.15,1449.75,371.05,236.45,374.00,285.35,328.40,556.70];

finger_shear_trimmed =  [208.25,219.60,219.70,242.50,226.65,219.60,216.50,224.75,219.15,222.50,224.75,241.20, 189.65,181.85];
louse_shear_trimmed =   [120.94,214.00,136.55,211.60,189.45,228.10,101.10,164.80,238.15,112.75,135.55,101.10, 161.10,101.10,120.94,214.00,136.55,211.60];
...
[fin_h,p] = ttest2(finger_overall,louse_overall,"Tail","left", 'Vartype','unequal')
[pri_h,p] = ttest2(prismatic_overall,louse_overall,"Tail","left", 'Vartype','unequal')
[rev_h,p] = ttest2(revolute_overall,louse_overall,"Tail","left", 'Vartype','unequal')


% [overall_h,p] = ttest2(louse_overall,finger_overall,"Tail","left", 'Vartype','unequal')
% [overall_h,p] = ttest2(prismatic_overall,finger_overall,"Tail","left", 'Vartype','unequal')
% [overall_h,p] = ttest2(revolute_overall,finger_overall,"Tail","left", 'Vartype','unequal')
