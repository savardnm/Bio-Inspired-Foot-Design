...
function sysCall_init()
    ...
    force_value = sim.getStringParameter(sim.stringparam_app_arg3)
...
function control_loop(input_force_value)
    ...
    if math.abs(force) > milestone then
        print("H: F:", final_force, "\tPos:", position_value, "\tT:", simulationTime)
...
function sysCall_cleanup()
    print("Final Horizontal Force:", final_force)
